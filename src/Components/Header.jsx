  ...
  return (
          ...
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-4">
              <img
                ...
                className="w-8 h-8"
              />
              <h1 className="text-3xl font-bold text-black-600">Untitled UI</h1>
            </div>
    ...
    <div className="col-span-2">
      <div className="flex items-start mb-3">
        ...
        />
        <div>
          <h3 className="text-purple-600 text-base font-bold text-left">Blog 1</h3>
      ...
      <div className="flex items-start mb-3">
        ...
        />
        <div>
          <h3 className="text-purple-600 text-base font-bold text-left">Customer Stories</h3>
          <p className="text-gray-600 text-sm mt-1">
      ...
      <div className="flex items-start">
        ...
        />
        <div>
          <h3 className="text-purple-600 text-base font-bold text-left">Video Tutorials</h3>
          <p className="text-gray-600 text-sm mt-1">
